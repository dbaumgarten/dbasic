...
- All variables are global (without scope) and of type signed int (but the PRINT command can still output string constants)
- There are no functions
- Currently no stdlib or options to call c-functions
